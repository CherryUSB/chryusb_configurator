...
export class compileCherryUSB {
    ...
    public check(): boolean {
        ...
        if (!isUint16(this.baseInfo.device.version)) {
                    ...
                    ssitem.endpoint.forEach((sssitem, sssindex) => {
                        ...
                        switch (sssitem.type) {
                                ...
                                switch (this.baseInfo.device.usb) {
                                    ...
                                    case 2.1:
                                        if (!isNumber(sssitem.size) || sssitem.size <= 0 || sssitem.size > 64) {
                                            this.log.e(`错误的端点描述符 Size, 控制端点应当在 [1-64] 之间, [${sssitem.size}], [${this.baseInfo.config[0].group[index]}]`)
                                            flag = false;
                                            return false;
                                        }
                                        break;
                            ...
                            case EUSBEndpointType.ISOC: {
                                switch (this.baseInfo.device.usb) {
                                    case 1.1:
                                        if (!isNumber(sssitem.size) || sssitem.size <= 0 || sssitem.size > 1023) {
                                            this.log.e(`错误的端点描述符 Size, USB1.1 同步端点应当在 [1-1023] 之间, [${sssitem.size}], [${this.baseInfo.config[0].group[index]}]`)
                                            flag = false;
                                            return false;
                                        }
                                        break;
                                    ...
                                    case 2.1:
                                        if (!isNumber(sssitem.size) || sssitem.size <= 0 || sssitem.size > 64) {
                                            this.log.e(`错误的端点描述符 Size, USB2.x 同步端点应当在 [1-1024] 之间, [${sssitem.size}], [${this.baseInfo.config[0].group[index]}]`)
                                            flag = false;
                                            return false;
                                        }
                                        break;
                            ...
                            case EUSBEndpointType.BULK: {
                                switch (this.baseInfo.device.usb) {
                                    case 1.1:
                                        if (!isNumber(sssitem.size) || sssitem.size <= 0 || sssitem.size > 64) {
                                            this.log.e(`错误的端点描述符 Size, USB1.1 BULK端点应当在 [1-64] 之间, [${sssitem.size}], [${this.baseInfo.config[0].group[index]}]`)
                                            flag = false;
                                            return false;
                                        }
                                        break;
                                    case 2.0:
                                    case 2.1:
                                        if (!isNumber(sssitem.size) || sssitem.size <= 0 || sssitem.size > 512) {
                                            this.log.e(`错误的端点描述符 Size, USB2.x BULK端点应当在 [1-512] 之间, [${sssitem.size}], [${this.baseInfo.config[0].group[index]}]`)
                                            flag = false;
                                            return false;
                                        }
                                        break;
                            ...
                            case EUSBEndpointType.INTR: {
                                switch (this.baseInfo.device.usb) {
                                    case 1.1:
                                        if (!isNumber(sssitem.size) || sssitem.size <= 0 || sssitem.size > 64) {
                                            this.log.e(`错误的端点描述符 Size, USB1.1 中断端点应当在 [1-64] 之间, [${sssitem.size}], [${this.baseInfo.config[0].group[index]}]`)
                                            flag = false;
                                            return false;
                                        }
                                        break;
                                    case 2.0:
                                    case 2.1:
                                        if (!isNumber(sssitem.size) || sssitem.size <= 0 || sssitem.size > 1024) {
                                            this.log.e(`错误的端点描述符 Size, USB2.x BULK端点应当在 [1-1024] 之间, [${sssitem.size}], [${this.baseInfo.config[0].group[index]}]`)
                                            flag = false;
                                            return false;
                                        }
                                        break;
